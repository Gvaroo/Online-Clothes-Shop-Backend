...
namespace OnlineShopApp.Migrations
{
    ...
    [Migration("20240517163340_updatedCartItemAndOrderItemClassesForProductSize")]
    partial class updatedCartItemAndOrderItemClassesForProductSize
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Cart.Cart", b =>
                {
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Cart.CartItem", b =>
                {
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Product.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Product.ProductBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Product.ProductColor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Product.Size", b =>
                {
                    b.Property<int>("SizeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductSize", b =>
                {
                    ...
                    b.HasKey("ProductsId", "SizesSizeId");
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Cart.Cart", b =>
                {
                    b.HasOne("OnlineShopApp.Models.Auth.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("OnlineShopApp.Models.Cart.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Cart.CartItem", b =>
                {
                    b.HasOne("OnlineShopApp.Models.Cart.Cart", "Cart")
                        .WithMany("CartItem")
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Product.Product", b =>
                {
                    ...
                    b.HasOne("OnlineShopApp.Models.Product.Gender", "Gender")
                        .WithMany("Product")
                        .HasForeignKey("GenderId");

                    b.HasOne("OnlineShopApp.Models.Product.ProductBrand", "ProductBrand")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ProductProductColor", b =>
                {
                    b.HasOne("OnlineShopApp.Models.Product.ProductColor", null)
                        .WithMany()
                        .HasForeignKey("ProductColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineShopApp.Models.Product.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductSize", b =>
                {
                    ...
                    b.HasOne("OnlineShopApp.Models.Product.Size", null)
                        .WithMany()
