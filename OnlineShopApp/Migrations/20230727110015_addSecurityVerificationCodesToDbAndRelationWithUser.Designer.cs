...
namespace OnlineShopApp.Migrations
{
    ...
    [Migration("20230727110015_addSecurityVerificationCodesToDbAndRelationWithUser")]
    partial class addSecurityVerificationCodesToDbAndRelationWithUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineShopApp.Models.Auth.SecurityVerificationCodes", b =>
                {
                    b.HasOne("OnlineShopApp.Models.Auth.User", "User")
                        .WithOne("securityVerificationCodes")
                        .HasForeignKey("OnlineShopApp.Models.Auth.SecurityVerificationCodes", "UserId")
